...
namespace UsuariosApi.Services
{
    public class LoginService
    {
        ...
        {
            CustomIdentityUser identityUser = RecuperaUsuario(request);
        ...
        private CustomIdentityUser RecuperaUsuario(IResetRequest request)
        {
            return _signInManager
                            .UserManager
                            .Users.FirstOrDefault(user => user.NormalizedEmail == request.Email.ToUpper());
        }
    }
}
